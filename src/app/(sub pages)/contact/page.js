...
import Form from "@/app/components/contacts/Form";
  ...
  return (
    <>
      ...
      <article className=" relative w-full flex flex-col items-center justify-center py-8 sm:py-0 space-y-8">
        <div className="flex flex-col items-center justify-center space-y-6 w-full sm:*:w-3/4 text-white">
          <h1 className="font-semibold text-center text-4xl capitalize text-yellow-400">
            Summon The Wizard
          </h1>
